...
namespace RecordSocialServicesProvision.res.view
{
    ...
    public partial class WaitingList : UserControl
    {
        ...
        // отказать заявке
        private void RefuseApplication_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            MySQLBD.setApproved(id, false);
            getData();
        }

        // принять заявку
        private void ApproveApplication_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            MySQLBD.setApproved(id, true);
            getData();
        }
    }
}